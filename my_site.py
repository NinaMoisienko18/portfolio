...
with st.sidebar:
    ...
    selected = option_menu("Projects", ["Analysis of world religions", "Analysis of space travellers"],
        icons=["star","rocket"],
        default_index=0,
        styles={
            "container": {"padding": "0!important", "background-color": "#FEFEFE"},
            "icon": {"color": "#D0293A", "font-size": "20px"},
            "nav-link": {"font-size": "17px", "text-align": "left", "margin": "0px", "--hover-color": "#eee"},
            "nav-link-selected": {"background-color": "#FF9B9B"}},
        menu_icon='laptop'
    )
...
if selected == "Analysis of space travellers":
